...
def main(args):
    ...
    training_loader = build_train_loader(dataset, args, metric=True)
    ...
    # inversion_dataset = Dataset(args.data_root, "msmt17", exemplars=args.exemplars)
    training_loader_prec = build_train_loader(inversion_dataset, args, metric=True)
    ...
    # Trainer
    trainer = trainers.InversionIncrementalTrainer(networks_prec,
                                                   networks,
    ...
    # trainer = trainers.IncrementalTrainer(networks_prec,
    #                                       networks,
    #                                       len(dataset.train_ids),
    #                                       optimizer_main,
    #                                       lr_scheduler,
    ...
    # trainer = trainers.AlwaysBeDreamingTrainer(networks_prec,
    #                                            networks,
    #                                            len(dataset.train_ids),
    #                                            optimizer_main,
    #                                            lr_scheduler,
