...
from ppcls.utils.data.dataset import Dataset, InversionDataset
from ppcls.utils.data import build_test_loader, build_train_loader
from ppcls.evaluation.evaluators import Evaluator
from ppcls.utils.serialization import load_checkpoint, CheckpointManager
from ppcls.utils.lr_schedulers import WarmupLRScheduler
...
def main(args):
    ...
    for epoch in range(epoch, args.epochs + 1):
        ...
        manager.save(epoch=epoch, fpath=osp.join(args.logs_dir, 'checkpoint.pdparams'))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data-root', type=str, metavar='PATH', default=osp.join(working_dir, '../data/lite_data'))
    ...
    parser.add_argument('--logs-dir', type=str, metavar='PATH', default=osp.join(working_dir, 'logs/msmt17-market_XsimGD'))
    parser.add_argument("--save-freq", type=int, default=100)
    parser.add_argument("--optimizer", type=str, choices=['SGD', 'Adam'], default="SGD")
    parser.add_argument("--warmup", type=int, default=0)
    parser.add_argument('--learning-rate', type=float, default=0.01)
    parser.add_argument("--evaluate", type=int, default=10)
    parser.add_argument("--previous", type=str, default='./logs/msmt17')
    parser.add_argument("--inversion-dir", type=str, default='./data/lite_data/generations_r50_msmt17')
    # data configs
    ...
    parser.add_argument("--algo-config", type=str, default="./configs/inverXion.yaml")
