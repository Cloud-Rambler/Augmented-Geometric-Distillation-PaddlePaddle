...
from ppcls.arch import Linear, ResNet as FeatureExtractor
from ppcls.utils.data.transforms import RandomErasingMask
from ppcls.utils.logging import Logger
...
def main():
    ...
    parser.add_argument('--verifier', action='store_true', help='evaluate batch with another arch')
    parser.add_argument('--verifier_arch', type=str, default='mobilenet_v2',
                        help="arch name from torchvision arch to act as a verifier")
