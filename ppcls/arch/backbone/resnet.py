...
from ppcls.utils.utils import DivisibleDict
from ppcls.utils.kaimingnormal import kaiming_normal_
import sys


model_path = {
    'resnet34': './checkpoints/ResNet34_pretrained.pdparams',
    'resnet50': './checkpoints/ResNet50_pretrained.pdparams',
}
...
class ResNet(nn.Layer):
    ...
    def __init__(self, depth=50, pretrained=True, last_stride=2, last_pooling='avg', embedding=256):
        ...
        if pretrained:
            ...
            assert osp.isfile(
                osp.expanduser(ckpt)), "paddle pretrained arch doesn't exists."
