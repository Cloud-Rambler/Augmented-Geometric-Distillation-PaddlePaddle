...
from ppcls.trainers import IncrementalTrainer
from ppcls.loss import ClassificationDistillationLoss, MetricDistillationLoss
...
class GenerationIncrementalTrainer(IncrementalTrainer):
    ...
    def generate_batch(self, batch_size=64):
        ...
        merged = paddle.cat([embedded_targets, noise], dim=-1).cuda()
