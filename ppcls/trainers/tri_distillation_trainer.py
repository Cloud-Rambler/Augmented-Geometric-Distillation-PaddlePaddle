...
from ppcls.loss import base
from ppcls.utils import AverageMeters, AverageMeter
from ppcls.loss.distillation import pairwise_residual
...
class TriDistillationTrainer(InversionIncrementalTrainer):
    ...
    def train_step(self, inputs, pids, inputs_prec, pids_prec):
        ...
        New data + preview arch -> outputs_prev
        """
